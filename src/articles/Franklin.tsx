...
export default function FranklinArticle(){
    ...
    <GenericArticle 
            ...
            title="Franklin" date="February 2024" description="All about Franklin: my 3D printed self-balancing robot" readTime="0 minutes" titleImage="https://polybrain.b-cdn.net/contribute-art.png"    
    >
